...
compile()
{
  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"../../../../Encryption_Engine.gen/sources_1/bd/FIFO/ipshared/3242" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Encryption_Engine.gen/sources_1/bd/FIFO/ipshared/3242" \
