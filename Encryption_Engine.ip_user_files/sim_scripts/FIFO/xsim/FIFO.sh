...
#
# Script generated by Vivado on Sat Jan 18 17:44:02 AST 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L fifo_generator_v13_2_10 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot FIFO xil_defaultlib.FIFO xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kryozek/Vivado/Vivado/2024.1/data/xsim"
  fi
