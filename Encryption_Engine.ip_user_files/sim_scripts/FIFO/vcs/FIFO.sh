...
compile()
{
  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../../Encryption_Engine.gen/sources_1/bd/FIFO/ipshared/3242" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../Encryption_Engine.gen/sources_1/bd/FIFO/ipshared/3242" \
